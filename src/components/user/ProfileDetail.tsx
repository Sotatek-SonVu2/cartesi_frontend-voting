...
import { DeleteButton, EditButton, JoinButton, ProfileDesc, ProfileInfo, ProfileName } from "styled/profile"
                ...
                <Content>
                    <HeaderList>
                        ...
                        {data.managers?.indexOf(addressWallet) !== -1 ? (
                            <div>
                                <EditButton onClick={() => navigate(`${ROUTER_PATH.EDIT_PROFILE}/${profileId}`)}>Edit</EditButton>
                    ...
                    {campaigns?.length > 0 && campaigns.map((item: ProfileCampaignDataType) => (
