	...
	return (
		<>
			...
			<Container>
				...
				<p>
					This voting DApp was developed on top of Cartesi Rollups and showcases voting
					functionality. It enables users to vote on candidates in listed campaigns. Furthermore,
					users can create their own campaigns and add candidate options to vote on. This
					showcase/module can be used to build more complex DApps and can be utilised for voting in
					DAOs.
				</p>
